...
export default {
  data () {
    return {
      ...
      dataForm: {
        ...
        imgUrl: '',
        orderValue: '50',
        property: this.$config.columnProperty.COMMON,
        displayFlag: true,
        memo: ''
      },
      dataFormRules: {
  ...
  mounted () {
    this.dataForm.columnProperty = this.$config.columnProperty.COMMON
    // this.dataForm.columnId = this.$config.columnProperty.COMMON
    this.loadData()
  },
  methods: {
    loadData () {
    ...
    handleClearForm () {
      ...
      this.dataForm.property = this.$config.columnProperty.COMMON
